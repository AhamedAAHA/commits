  ...
  return (
    ...
    >
      <div className="relative mx-auto grid max-w-5xl items-center gap-12 lg:grid-cols-[1fr_minmax(240px,320px)] lg:gap-14">
        <div className="min-w-0">
          <motion.p
            ...
            className="font-mono-ui glass mb-6 inline-flex items-center gap-2 rounded-full px-4 py-2 text-[11px] uppercase tracking-[0.2em] text-[var(--aurora-cyan)]"
          >
          ...
          >
            ...
            <MagneticButton
              ...
              className="focus-ring items-center justify-center gap-2 rounded-full border border-[oklch(0.72_0.19_290_/0.4)] bg-[oklch(0.62_0.19_290_/0.16)] px-6 py-3 text-sm font-semibold text-[var(--ink)] shadow-[0_12px_36px_-14px_oklch(0.2_0.1_290_/0.72)] backdrop-blur-md transition hover:bg-[oklch(0.62_0.19_290_/0.26)]"
            >
      ...
      >
        ...
        <motion.span
          className="h-8 w-px bg-gradient-to-b from-[var(--aurora-cyan)] to-transparent"
